...
def td3_plot():
    ...
    fig_save_path = figures_dir + '/TD3_' + 'resource_allocation' + '_fig_' + str(fig_num) + '.pdf'


    # get number of log files in directory
    log_dir = "TD3_files" + '/' + 'resource_allocation' + '/' + 'stability' + '/'
    ...
    ax.legend(['TD3_32','TD3_64','TD3_256'], fontsize=11, loc='lower right')
    fig = plt.gcf()
    fig.tight_layout()
